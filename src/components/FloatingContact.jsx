        ...
        <>
            ...
            >
                <svg viewBox="0 0 24 24" fill="currentColor" className="wa-icon">
                    <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.182-.573c.978.58 1.913.928 3.145.929 3.178 0 5.767-2.587 5.768-5.766.001-3.187-2.575-5.77-5.764-5.771zm3.392 8.244c-.144.405-.837.774-1.17.824-.299.045-.677.063-2.846-.828-.921-.382-1.55-1.034-1.653-1.179-.103-.146-.662-.884-.662-1.685 0-.801.432-1.233.593-1.428.169-.204.385-.246.529-.246.144 0 .284.008.406.008.136 0 .313.065.474.453.167.4.57 1.393.62 1.494.05.101.077.219.014.348-.063.128-.098.208-.198.318-.104.114-.216.246-.307.337-.101.101-.205.213-.086.417.119.203.524.861 1.13 1.401.782.695 1.444.912 1.649 1.015.205.102.325.086.444-.051.12-.137.514-.596.652-.8.137-.204.281-.17.47-.1.189.068 1.196.564 1.4.665.204.102.342.152.392.238.051.085.051.493-.093.898z" />
                </svg>
            </a>
            ...
            <button className="fab-ai" onClick={toggleChat}>
                <div className="ai-avatar-container">
                    <img src="/rusheng_real.jpg" alt="Rusheng AI" className="ai-avatar" />
                    ...
                    >
                        <div className="chat-header">
                            <div className="header-info">
                                <img src="/rusheng_real.jpg" alt="Bot" className="header-avatar" />
                                <div>
                                    <h4>Rusheng AI</h4>
                                    <span className="status">Using DeepSeek Intelligence</span>
                                </div>
                            </div>
