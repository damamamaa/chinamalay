export const content = {
  en: {
    ...
    contact: {
      ...
      whatsapp: {
        label: "WhatsApp",
        tcm_msg: "Hi, I would like to enquire about TCM services.",
        xj_msg: "Hi, I would like to enquire about Xin Jian Destiny services."
      }
    },
    footer: {
  ...
  ms: {
    ...
    contact: {
      ...
      whatsapp: {
        label: "WhatsApp",
        tcm_msg: "Hai, saya ingin bertanya tentang perkhidmatan TCM.",
        xj_msg: "Hai, saya ingin bertanya tentang perkhidmatan Xin Jian."
      }
    },
    footer: {
      brand: "Live true care",
